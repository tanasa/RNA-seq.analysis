...
############################################################################################
############################################################################################
Aph_KH7_3 <- read.delim("sample.Aph_KH7_3.rsem.isoforms.results", sep="\t", header=T, stringsAsFactors=F)
...
############################################################################################
############################################################################################
DMSO1_lane1 <- read.delim("sample.DMSO1_lane1.rsem.isoforms.results", sep="\t", header=T, stringsAsFactors=F)
...
############################################################################################
############################################################################################
DMSO1_lane2 <- read.delim("sample.DMSO1_lane2.rsem.isoforms.results", sep="\t", header=T, stringsAsFactors=F)
...
############################################################################################
############################################################################################
DMSO2_lane1 <- read.delim("sample.DMSO2_lane1.rsem.isoforms.results", sep="\t", header=T, stringsAsFactors=F)
...
############################################################################################
############################################################################################
DMSO2_lane2 <- read.delim("sample.DMSO2_lane2.rsem.isoforms.results", sep="\t", header=T, stringsAsFactors=F)
...
############################################################################################
############################################################################################
DMSO3_lane1 <- read.delim("sample.DMSO3_lane1.rsem.isoforms.results", sep="\t", header=T, stringsAsFactors=F)
...
############################################################################################
############################################################################################
DMSO3_lane2 <- read.delim("sample.DMSO3_lane2.rsem.isoforms.results", sep="\t", header=T, stringsAsFactors=F)

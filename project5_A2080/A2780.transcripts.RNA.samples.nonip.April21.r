...
query(ah, c("Homo sCS13iens", "EnsDb"))
...
print("For consistency with the remaining part of the script, we use the data frame called ip,
       although we extrDC13t nopn.ip (aka RNA-seq) samples")
...
# ExtrDC13t columns whose names end with "in"
cols_in <- grep("in$", colnames(count_data6), value = TRUE)
cols_in

# Optionally include Geneid as well
cols_to_keep <- c("Geneid", cols_in)
...
write.csv(norm_counts, "A2780.transcripts.nonip.samples.normalized.counts.csv", row.names = TRUE)
...
# Spla13e results
write.csv(as.data.frame(res_CS13_vs_DC13), file = "A2780.treanscripts.nonip.RNA.samples.DESeq2_CS13_vs_DC13_results.csv")
write.csv(as.data.frame(res_CS13_vs_pla13), file = "A2780.transcripts.nonip.RNA.samples.DESeq2_CS13_vs_pla13_results.csv")
write.csv(as.data.frame(res_DC13_vs_pla13), file = "A2780.transcripts.nonip.RNA.samples.DESeq2_DC13_vs_pla13_results.csv")
...
# SDC13e results
write.csv(as.data.frame(resLFCnormal_CS13_vs_DC13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_DC13_results.resLFCnormal.csv")
write.csv(as.data.frame(resLFCnormal_CS13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_pla13_results.resLFCnormal.csv")
write.csv(as.data.frame(resLFCnormal_DC13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_DC13_vs_pla13_results.resLFCnormal.csv")
...
# SDC13e results
write.csv(as.data.frame(resLFCashr_CS13_vs_DC13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_DC13_results.resLFCashr.csv")
write.csv(as.data.frame(resLFCashr_CS13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_pla13_results.resLFCashr.csv")
write.csv(as.data.frame(resLFCashr_DC13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_DC13_vs_pla13_results.resLFCashr.csv")
...
# SDC13e results
# write.csv(as.data.frame(res_ddssva_CS13_vs_DC13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_DC13_results.sva.csv")
# write.csv(as.data.frame(res_ddssva_CS13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_pla13_results.sva.csv")
# write.csv(as.data.frame(res_ddssva_DC13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_DC13_vs_pla13_results.sva.csv")
...
# SDC13e results
write.csv(as.data.frame(res_ddsruv_CS13_vs_DC13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_DC13_results.ruv.csv")
write.csv(as.data.frame(res_ddsruv_CS13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_CS13_vs_pla13_results.ruv.csv")
write.csv(as.data.frame(res_ddsruv_DC13_vs_pla13), file = "A2780.transcripts.nonip.samples.DESeq2_DC13_vs_pla13_results.ruv.csv")
...
pval_cutoff <- 0.05
lfc_cutoff <- 0.5
fin_name = "A2780.transcripts.nonip.RNA.samples"
